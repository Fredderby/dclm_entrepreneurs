...
function App() {
  ...
  const validateForm = () => {
    ...
    if (!formData.pastor_name.trim())
      errors.push("• Pastor's Name is required");
    else if (hasNumbers(formData.pastor_name))
      errors.push("• Pastor's Name cannot contain numbers");

    if (!formData.pastor_contact.trim())
      errors.push("• Pastor's Contact is required");
    else if (!isValidPhone(formData.pastor_contact))
      errors.push("• Pastor's Contact must be exactly 10 digits");

    if (!formData.entrepreneur_full_name.trim())
      errors.push("• Entrepreneur: Full Name required");
    else if (hasNumbers(formData.entrepreneur_full_name))
      errors.push("• Entrepreneur: Name cannot contain numbers");

    if (!formData.entrepreneur_phone_whatsapp.trim())
      errors.push("• Entrepreneur: Phone required");
    else if (!isValidPhone(formData.entrepreneur_phone_whatsapp))
      errors.push("• Entrepreneur: Phone must be 10 digits");

    if (!formData.entrepreneur_business_name_type.trim())
      errors.push("• Entrepreneur: Business Name required");
    else if (hasNumbers(formData.entrepreneur_business_name_type))
      errors.push("• Entrepreneur: Business Name cannot contain numbers");

    if (!formData.entrepreneur_business_location.trim())
      errors.push("• Entrepreneur: Location of Business is required");

    if (!formData.entrepreneur_sector)
      errors.push("• Entrepreneur: Select Business Sector");
    if (!formData.entrepreneur_years_in_business)
      errors.push("• Entrepreneur: Select Years in Business");
    if (!formData.entrepreneur_can_mentor)
      errors.push("• Entrepreneur: Select Mentorship option");
  ...
  const handleSubmit = async (e) => {
    ...
    if (
      !window.confirm(
        "⚠️ Double-check all details before final submission.\n\nDo you want to submit now?",
      )
    )
      return;
    setLoading(true);
    try {
      ...
      setError(
        "Submission failed: " + (err.response?.data?.detail || err.message),
      );
    } finally {
      setLoading(false);
    }
      ...
      >
        <div
          style={{
            ...
            minWidth: 0,
            background:
              "linear-gradient(rgba(255,255,255,0.85), rgba(255,255,255,0.85)), url(https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?ixlib=rb-4.0.3&auto=format&fit=crop&w=1350&q=80)",
          ...
          <img
            ...
            onError={(e) => {
              ...
              e.target.insertAdjacentHTML(
                "afterend",
                '<div style="font-weight:bold; font-size:clamp(1.1rem,4vw,1.4rem); color:#1a73e8; background:rgba(255,255,255,0.9); padding:0.5rem 0.7rem; border-radius:10px; flex-shrink:0;">DCLM</div>',
              );
            }}
          />
          ...
          >
            ...
            >
              <div style={{ width: "100%" }}>
                ...
                >
                  ...
                  {Object.keys(zone_region_divisions).map((z) => (
              ...
              <div style={{ width: "100%" }}>
                ...
                >
                  ...
                  {selectedZone &&
                    Object.keys(zone_region_divisions[selectedZone]).map(
                      (r) => (
              ...
              <div style={{ width: "100%" }}>
                ...
                >
                  ...
                  {selectedRegion &&
                    zone_region_divisions[selectedZone][selectedRegion].map(
                      (d) => (
            ...
            >
              ...
              >
                ...
                >
                  Pastor's Name <span style={{ color: "red" }}>*</span>
                </label>
                <input
                  type="text"
                  name="pastor_name"
              ...
              <div style={{ width: "100%", boxSizing: "border-box" }}>
                ...
                >
                  Pastor's Contact{" "}
                  <small style={{ color: "#78909c", fontWeight: "normal" }}>
                    (10 digits)
                  </small>{" "}
            ...
            >
              ...
              >
                <div style={{ width: "100%", boxSizing: "border-box" }}>
                  ...
                  <input
                    type="text"
                    name="entrepreneur_full_name"
                    value={formData.entrepreneur_full_name}
                    onChange={handleChange}
                    required
                    style={{
                      width: "100%",
                ...
                <div style={{ width: "100%", boxSizing: "border-box" }}>
                  ...
                  <input
                    ...
                    value={formData.entrepreneur_phone_whatsapp}
                    onChange={handleChange}
                    required
                    style={{
                      width: "100%",
              ...
              >
                ...
                >
                  Business Name & Type <span style={{ color: "red" }}>*</span>
                </label>
                <input
                  type="text"
                  name="entrepreneur_business_name_type"
                  value={formData.entrepreneur_business_name_type}
                  onChange={handleChange}
                  required
                  style={{
                    width: "100%",
              ...
              >
                ...
                >
                  Location of Business <span style={{ color: "red" }}>*</span>
                </label>
                <input
                  type="text"
                  name="entrepreneur_business_location"
                  value={formData.entrepreneur_business_location}
                  onChange={handleChange}
                  required
                  placeholder="e.g. City, Town, District"
                  style={{
                    width: "100%",
                    padding: "0.9rem 1rem",
                    borderRadius: "8px",
              ...
              >
                <div style={{ width: "100%", boxSizing: "border-box" }}>
                  ...
                  <select
                    name="entrepreneur_sector"
                    value={formData.entrepreneur_sector}
                    onChange={handleChange}
                    required
                    style={{
                      width: "100%",
                ...
                <div style={{ width: "100%", boxSizing: "border-box" }}>
                  ...
                  <select
                    name="entrepreneur_years_in_business"
                    value={formData.entrepreneur_years_in_business}
                    onChange={handleChange}
                    required
                    style={{
                      width: "100%",
                ...
                <div style={{ width: "100%", boxSizing: "border-box" }}>
                  ...
                  >
                    Available to Mentor? <span style={{ color: "red" }}>*</span>
                  </label>
                  <select
                    name="entrepreneur_can_mentor"
                    value={formData.entrepreneur_can_mentor}
                    onChange={handleChange}
                    required
                    style={{
                      width: "100%",
